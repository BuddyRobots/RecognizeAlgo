...
namespace MagicCircuit
{
    public class ColorThreshold
    {
        ...
        public void getComponents(Mat frame, ref List<Mat> l_roi, ref List<OpenCVForUnity.Rect> rect)
        {
            Mat hsvImg = new Mat();
        ...
        public void getLine(Mat frame, ref List<Mat> l_roi, ref List<OpenCVForUnity.Rect> rect)
        {
            Mat hsvImg = new Mat();
            Mat resultImg = new Mat();
            Mat lineImg = new Mat();
